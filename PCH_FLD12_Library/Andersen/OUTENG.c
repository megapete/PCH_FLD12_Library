/* OUTENG.F -- translated by f2c (version 20100827).
...
#define outeng_block1_1 outeng_block1_

/* Table of constant values */

static integer outeng_c__80 = 80;
static integer outeng_c__1 = 1;
static integer outeng_c__2 = 2;
static integer outeng_c__3 = 3;
static real outeng_c_b369 = 1.f;

/* --- OUTPUT PROGRAM FLD12, ENGLISH UNITS */

/* Main program */ int __stdcall OUTENGMAIN__(char *baseDirectory)
{
	memset(&outeng_block1_1, 0, sizeof(outeng_block1_1));
    ...
    static char fmt_10[] = "(\002PROGRAM FLD12\002,7x,\002COMPLEX POTENTIAL "
	    ...
	    "UNDARY\002,f8.3,16x,\002TANK\002,f7.2/\002Z - UPPER BOUNDARY\002"
	    ",f8.3,16x,\002LEG\002,f8.2/\002CORE DIAMETER\002,f7.3,22x,\002YO"
	    "KE\002,f7.2/\002DISTANCE WINDING-TANK\002,f7.3,12x,\002SCALE, FL"
    ...
    static char fmt_19[] = "(f5.1,f6.1,f8.3,f8.3,2f7.1,f9.1,f10.1,f9.3,f8.3)";
    ...
    static char fmt_27[] = "(/\002AXIAL POSITIONS, HORIZONTAL GRID LINES\002)"
	    ;
    static char fmt_28[] = "(i3,5x,10f7.2)";
    static char fmt_29[] = "(i3,\002-\002,i2,2x,10f7.2)";
    static char fmt_30[] = "(i3,\002-\002,i3,1x,10f7.2)";
    ...
    static char fmt_32[] = "(\002STRESSES DUE TO COMBINED FORCES ARE BENDING"
	    " STRESSES DUE TO 'MAX. LBS/CUB.INCH,\002/\002AXIALLY' COMBINED W"
	    "ITH TENSION OR COMPRESSION DUE TO 'MIN. LBS/AXIAL INCH,\002/\002"
	    "RADIALLY'. BENDING STRESS IS CALCULATED FOR A BUILT-IN BEAM WITH"
	    " A LENGTH\002/\002EQUAL TO THE AVERAGE SPACER PITCH MINUS HALF T"
	    "HE SPACER WIDTH. IT IS CALCULATED\002/\002TOO HIGH FOR BONDED CT"
	    "C, AGAIN BECAUSE NO BONDING IS ASSUMED IN THE\002/\002CALCULATIO"
	    "NS.\002/)";
    static char fmt_33[] = "(/\002SEGMENT NUMBER\002,f6.1/\002  AMPERETURN"
	    "S\002,f11.1,12x,\002FORCES AT PEAK SHORT CIRCUIT CURRENT\002/"
	    "\002  KVA\002,f10.2,23x,\002TOTAL RADIALLY, LBS\002,f12.1/\002DC"
	    " LOSS\002,31x,\002TOTAL AXIALLY, LBS\002,f13.1/\002  W/CUB.INCH "
	    "GROSS VOLUME\002,f7.3,6x,\002MIN. LBS/AXIAL INCH, RADIALLY\002,f"
	    "10.1/\002  KW TOTAL\002,f8.3,20x,\002MAX. LBS/AXIAL INCH, RADIAL"
	    "LY\002,f10.1/\002EDDY CURRENT LOSS\002,21x,\002MAX. ACCUM. AXIAL"
	    "LY, LBS\002,f12.1/\002  KW DUE TO AXIAL FLUX\002,f8.3,8x,\002MAX"
	    ". LBS/CUB.INCH, AXIALLY\002,f10.1/\002  KW DUE TO RADIAL FLUX"
	    "\002,f7.3,6x,\002DUE TO RADIAL FORCES\002/\002  KW TOTAL\002,f7."
	    "3,21x,\002LBS/SQ.INCH TENSION/COMPRESSION\002,f9.1/\002  PER UNI"
	    "T, AVERAGE\002,f7.4,12x,\002MIN. NUMBER OF SPACER BARS\002,f5.1)";
    ...
    static char fmt_35[] = "(\002MAX. PU CURRENT DENSITY\002,f7.4,6x,\002DUE"
	    " TO AXIAL FORCES\002)";
    static char fmt_36[] = "(\002  OCCURS BETWEEN\002,22x,\002LBS/SQ.INCH IN"
	    " SPACER BLOCKS\002,f8.1)";
    static char fmt_37[] = "(\002  OCCURS BETWEEN\002,22x,\002LBS/SQ.INCH IN"
	    " INSULATION\002,f8.1)";
    static char fmt_38[] = "(\002 R-MIN   R-MAX   Z-MIN   Z-MAX\002,6x,\002D"
	    "UE TO COMBINED FORCES\002/f6.3,3f8.3,8x,\002LBS/SQ.INCH BENDING+"
	    "TENS./COMPR.\002,f9.1)";
    static char fmt_39[] = "(//\002CRITICAL STRESSES ETC. AT PEAK SHORT CIRC"
	    "UIT CURRENT:\002/\002DUE TO RADIAL FORCES\002,32x,\002SEGMENT NO."
	    "\002/\002  LBS/SQ.INCH TENSION\002,f13.1,f25.1/\002  LBS/SQ.INCH"
	    " COMPRESSION\002,f9.1,f25.1/\002  MIN. NUMBER OF SPACER BARS\002"
	    ",f5.1,f26.1/\002DUE TO AXIAL FORCES\002/\002  LBS/SQ.INCH IN SPA"
	    "CER BLOCKS OR INSULATION\002,f8.1,f7.1/\002DUE TO COMBINED FORCES"
	    "\002/\002  LBS/SQ.INCH BENDING+TENS./COMPR.\002,f9.1,f16.1)";
    static char fmt_41[] = "(/\002VOLTS PER TURN\002,f8.3/\002MAX. RADIAL FL"
	    "UX DENSITY AT TANK (PEAK, KL/SQ.IN)\002,f6.2/\002MAX. RADIAL FLU"
	    "X DENSITY AT CORE LEG\002,f6.2)";
    ...
    static char fmt_44[] = "(\002  FORCES AT PEAK SHORT CIRCUIT CURRENT, LB"
	    "S\002/\002   MAX. ACCUMULATED AXIALLY\002,f10.1/\002   OCCURS IN"
	    " SEGMENT NO.\002,i4)";
    ...
    /* Local variables */
    static real b, outeng_c__, d__, e, f, g, h__;
	b = outeng_c__ = d__ = e = f = g = h__ = 0.0;
    static integer i__, j, k, l, m, n;
	i__ = j = k = l = m = n = 0;
    static real p, e1, e2, e3, e4;
	p = e1 = e2 = e3 = e4 = 0.0;
    static integer i1, j1, j2, j3, i5, i6, j4, k4, k2, k8;
	i1 = j1 = j2 = j3 = i5 = i6 = j4 = k4 = k2 = k8 = 0;
    static char s1[4];
	...
	zb = rl = rm = rn = zc = fz = xl = yl = zl = zm = zn = xm = ws = ym = xn = yn = zu = eal = fsc = ecu = 0.0;
    ...
    static real freq;
	freq = 0.0;
    extern /* Subroutine */ int outeng_subd_(real *, real *, real *, real *, real *, 
	    real *, real *);
    ...
    extern integer outeng_itri_(integer *, integer *);
    ...
    extern /* Subroutine */ int outeng_angle_(real *, real *, real *, real *, real *)
	    ;
    ...
    static cilist io___137 = { 0, 0, 0, fmt_10, 0 };
    static cilist io___139 = { 0, 0, 0, fmt_12, 0 };
    static cilist io___140 = { 0, 0, 0, fmt_13, 0 };
    static cilist io___141 = { 0, 0, 0, fmt_14, 0 };
    static cilist io___142 = { 0, 0, 0, fmt_15, 0 };
    static cilist io___143 = { 0, 0, 0, fmt_16, 0 };
    static cilist io___145 = { 0, 0, 0, fmt_17, 0 };
    static cilist io___146 = { 0, 0, 0, fmt_18, 0 };
    static cilist io___147 = { 0, 0, 0, fmt_19, 0 };
    static cilist io___148 = { 0, 0, 0, fmt_26, 0 };
    static cilist io___149 = { 0, 0, 0, fmt_28, 0 };
    static cilist io___150 = { 0, 0, 0, fmt_29, 0 };
    static cilist io___151 = { 0, 0, 0, fmt_30, 0 };
    static cilist io___152 = { 0, 0, 0, fmt_27, 0 };
    static cilist io___153 = { 0, 0, 0, fmt_28, 0 };
    static cilist io___154 = { 0, 0, 0, fmt_29, 0 };
    static cilist io___155 = { 0, 0, 0, fmt_30, 0 };
    static cilist io___160 = { 0, 0, 0, fmt_31, 0 };
    static cilist io___161 = { 0, 0, 0, fmt_32, 0 };
    static cilist io___242 = { 0, 0, 0, fmt_33, 0 };
    static cilist io___243 = { 0, 0, 0, fmt_34, 0 };
    static cilist io___244 = { 0, 0, 0, fmt_35, 0 };
    static cilist io___245 = { 0, 0, 0, fmt_36, 0 };
    static cilist io___246 = { 0, 0, 0, fmt_37, 0 };
    static cilist io___247 = { 0, 0, 0, fmt_38, 0 };
    static cilist io___248 = { 0, 0, 0, fmt_39, 0 };
    static cilist io___249 = { 0, 0, 0, fmt_41, 0 };
    static cilist io___250 = { 0, 0, 0, fmt_42, 0 };
    static cilist io___251 = { 0, 0, 0, fmt_43, 0 };
    static cilist io___263 = { 0, 0, 0, fmt_45, 0 };
    static cilist io___264 = { 0, 0, 0, fmt_64, 0 };
    static cilist io___265 = { 0, 0, 0, fmt_65, 0 };
    static cilist io___266 = { 0, 0, 0, fmt_66, 0 };
    static cilist io___267 = { 0, 0, 0, fmt_44, 0 };
    static cilist io___268 = { 0, 0, 0, fmt_47, 0 };
    static cilist io___269 = { 0, 0, 0, fmt_48, 0 };
    static cilist io___278 = { 0, 0, 0, fmt_49, 0 };
    static cilist io___279 = { 0, 0, 0, fmt_50, 0 };
    static cilist io___280 = { 0, 0, 0, fmt_46, 0 };
    static cilist io___281 = { 0, 0, 0, fmt_98, 0 };
    static cilist io___282 = { 0, 0, 0, fmt_51, 0 };
    static cilist io___283 = { 0, 0, 0, fmt_52, 0 };
    static cilist io___284 = { 0, 0, 0, fmt_53, 0 };
    static cilist io___285 = { 0, 0, 0, fmt_76, 0 };
    static cilist io___286 = { 0, 3, 0, 0, 0 };
    static cilist io___287 = { 0, 4, 0, fmt_99, 0 };
...
/* --- OPEN INPUT FILE */
    ...
    f_open(&o__1);
    s_rsfe(&io___10);
    do_fio(&outeng_c__80, ident, (ftnlen)1);
    e_rsfe();
    s_rsfe(&io___12);
    do_fio(&outeng_c__1, (char *)&units, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&phase, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&freq, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&limbs, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&fract, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&zb, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&zu, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&dcore, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&wntnk, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&shld, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&scgva, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&zopt, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&fpeak, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&e1, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&e2, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&dpel, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&dzde, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&ftank, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&fleg, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&fyoke, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&scale, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&flxln, (ftnlen)sizeof(real));
    e_rsfe();
/* --- NUMBER OF TERMINALS */
    nterm = e1;
/* --- NUMBER OF LAYERS */
	...
	for (j = 1; j <= 4; ++j) {
	    do_fio(&outeng_c__1, (char *)&term[i__ + j * 6 - 7], (ftnlen)sizeof(real)
		    );
	}
    }
    e_rsfe();
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
	for (j = 1; j <= 10; ++j) {
	    do_fio(&outeng_c__1, (char *)&layer[i__ + j * 30 - 31], (ftnlen)sizeof(
		    real));
	}
    }
    e_rsfe();
/* --- NUMBER OF SEGMENTS */
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
	for (j = 1; j <= 9; ++j) {
	    do_fio(&outeng_c__1, (char *)&seg[i__ + j * 200 - 201], (ftnlen)sizeof(
		    real));
	}
    }
    e_rsfe();
...
/* --- READ FROM GRAPHICS FILE */
    ...
    f_open(&o__1);
    s_rsfe(&io___50);
    do_fio(&outeng_c__1, (char *)&n, (ftnlen)sizeof(integer));
    do_fio(&outeng_c__1, (char *)&i5, (ftnlen)sizeof(integer));
    do_fio(&outeng_c__1, (char *)&i6, (ftnlen)sizeof(integer));
    do_fio(&outeng_c__1, (char *)&linto, (ftnlen)sizeof(integer));
    do_fio(&outeng_c__1, (char *)&outeng_block1_1.lnver, (ftnlen)sizeof(integer));
    do_fio(&outeng_c__1, (char *)&lnhor, (ftnlen)sizeof(integer));
    e_rsfe();
    s_rsfe(&io___56);
    do_fio(&outeng_c__1, (char *)&flaxi, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&flxln, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&scale, (ftnlen)sizeof(real));
    for (i__ = 1; i__ <= 300; ++i__) {
	do_fio(&outeng_c__1, (char *)&xpos[i__ - 1], (ftnlen)sizeof(real));
    }
    for (i__ = 1; i__ <= 300; ++i__) {
	do_fio(&outeng_c__1, (char *)&ypos[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___60);
    for (i__ = 1; i__ <= 150; ++i__) {
	do_fio(&outeng_c__1, (char *)&iln[i__ - 1], (ftnlen)sizeof(shortint));
    }
    e_rsfe();
    s_rsfe(&io___62);
    for (i__ = 1; i__ <= 3000; ++i__) {
	do_fio(&outeng_c__1, (char *)&linc[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___64);
    do_fio(&outeng_c__80, ident, (ftnlen)1);
    ...
    i__1 = linto;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&datln[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    nocol = outeng_block1_1.lnver - 1;
    j4 = i6 / 4;
    j2 = i6 / 2;
    j3 = j2 + j4;
    k8 = i5 / 8;
...
/* --- NODE COORDINATES IN MILLIMETERS */
    ...
    i__1 = j4;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&vert[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___76);
    i__1 = j2;
    ...
    i__1 = j4;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&vert[i__ + 29999], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___80);
    i__1 = j2;
...
/* --- REAL COMPONENTS OF ARRAY CPOT, COMPLEX VECTOR POTENTIALS */
    ...
    i__1 = j4;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&cpotr[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___85);
    i__1 = j2;
...
/* --- INFORMATION ABOUT THE GRID, STORED IN INDIVIDUAL BITS */
    ...
    i__1 = j2;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&outeng_block1_1.ibit[i__ - 1], (ftnlen)sizeof(
		shortint));
    }
    e_rsfe();
    s_rsfe(&io___89);
...
/* --- PERMEABILITIES */
    ...
    i__1 = k8;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&tri2[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___92);
    i__1 = k4;
    ...
    i__1 = k8;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&tri2[i__ + k2 - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___96);
    i__1 = k4;
...
/* --- IMAGINARY COMPONENTS OF ARRAY CPOT, COMPLEX VECTOR POTENTIALS */
    ...
    i__1 = j4;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&cpoti[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___109);
    i__1 = j2;
...
/* --- REAL AND IMAGINARY COMPONENTS OF ARRAY CDENS, CURRENT DENSITIES, A/SQ.M */
    ...
    i__1 = k8;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&cdensr[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___114);
    i__1 = k4;
    ...
    i__1 = k8;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&cdensr[i__ + k2 - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___118);
    i__1 = k4;
    ...
    i__1 = k8;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&cdensi[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___123);
    i__1 = k4;
    ...
    i__1 = k8;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&cdensi[i__ + k2 - 1], (ftnlen)sizeof(real));
    }
    e_rsfe();
    s_rsfe(&io___127);
    i__1 = k4;
    ...
    f_clos(&cl__1);
/* --- CONVERSION FACTORS */
/* --- TESLA TO KILOLINES/SQ.INCH */
    b = 64.516f;
/* --- MM TO INCHES */
    outeng_c__ = .03937007874015748f;
/* --- NEWTONS TO POUNDS FORCE */
    p = .2248090247334889f;
/* --- N/SQ.MM TO LBS/SQ.INCH */
    e = 145.03768078946911f;
/* --- N/MM TO LBS/INCH */
    f = p * 25.4f;
/* --- KW/CUB.DM TO W/CUB.INCH */
    g = 16.387063999999999f;
/* --- N/CUB.CM TO LBS/CUB.INCH */
    h__ = p * g;
/* --- WRITE PART OF INPUT */
/* L183: */
    io___137.ciunit = out;
    ...
    do_fio(&outeng_c__1, (char *)&fract, (ftnlen)sizeof(real));
    r__1 = zb * outeng_c__;
    do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&ftank, (ftnlen)sizeof(real));
    r__2 = zu * outeng_c__;
    do_fio(&outeng_c__1, (char *)&r__2, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&fleg, (ftnlen)sizeof(real));
    r__3 = dcore * outeng_c__;
    do_fio(&outeng_c__1, (char *)&r__3, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&fyoke, (ftnlen)sizeof(real));
    r__4 = wntnk * outeng_c__;
    do_fio(&outeng_c__1, (char *)&r__4, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&scale, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&shld, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&flxln, (ftnlen)sizeof(real));
    e_wsfe();
...
/* L184: */
    ...
    i__1 = nterm;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&term[i__ - 1], (ftnlen)sizeof(real));
    }
    e_wsfe();
    io___140.ciunit = out;
    s_wsfe(&io___140);
    i__1 = nterm;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, tstr + ((i__ - 1) << 2), (ftnlen)4);
    }
    e_wsfe();
    io___141.ciunit = out;
    s_wsfe(&io___141);
    i__1 = nterm;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&term[i__ + 11], (ftnlen)sizeof(real));
    }
    e_wsfe();
    io___142.ciunit = out;
    s_wsfe(&io___142);
    i__1 = nterm;
    for (i__ = 1; i__ <= i__1; ++i__) {
	do_fio(&outeng_c__1, (char *)&term[i__ + 17], (ftnlen)sizeof(real));
    }
    e_wsfe();
/* --- LAYER DATA */
    io___143.ciunit = out;
...
/* L186: */
	...
	for (j = 3; j <= 4; ++j) {
	    r__1 = layer[i__ + j * 30 - 31] * outeng_c__;
	    do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
	}
	for (j = 5; j <= 7; ++j) {
	    do_fio(&outeng_c__1, (char *)&layer[i__ + j * 30 - 31], (ftnlen)sizeof(
	...
	do_fio(&outeng_c__1, s1, (ftnlen)4);
	do_fio(&outeng_c__1, (char *)&layer[i__ + 239], (ftnlen)sizeof(real));
	r__2 = layer[i__ + 269] * outeng_c__;
	do_fio(&outeng_c__1, (char *)&r__2, (ftnlen)sizeof(real));
	e_wsfe();
    }
/* --- SEGMENT DATA */
...
/* L191: */
	io___147.ciunit = out;
	s_wsfe(&io___147);
	do_fio(&outeng_c__1, (char *)&seg[i__ - 1], (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 1799], (ftnlen)sizeof(real));
	for (j = 2; j <= 3; ++j) {
	    r__1 = seg[i__ + j * 200 - 201] * outeng_c__;
	    do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
	}
	for (j = 4; j <= 7; ++j) {
	    do_fio(&outeng_c__1, (char *)&seg[i__ + j * 200 - 201], (ftnlen)sizeof(
	...
	for (j = 8; j <= 9; ++j) {
	    r__2 = seg[i__ + j * 200 - 201] * outeng_c__;
	    do_fio(&outeng_c__1, (char *)&r__2, (ftnlen)sizeof(real));
	}
	e_wsfe();
    }
/* --- WRITE POSITIONS OF GRID LINES */
    ...
    k = 10;
L195:
    if (k > outeng_block1_1.lnver) {
	k = outeng_block1_1.lnver;
    }
    if (j == k) {
	io___149.ciunit = out;
	s_wsfe(&io___149);
	do_fio(&outeng_c__1, (char *)&j, (ftnlen)sizeof(integer));
	do_fio(&outeng_c__1, (char *)&xpos[j - 1], (ftnlen)sizeof(real));
	e_wsfe();
    }
    if (k <= 99 && j != k) {
	io___150.ciunit = out;
	s_wsfe(&io___150);
	do_fio(&outeng_c__1, (char *)&j, (ftnlen)sizeof(integer));
	do_fio(&outeng_c__1, (char *)&k, (ftnlen)sizeof(integer));
	i__1 = k;
	for (i__ = j; i__ <= i__1; ++i__) {
	    r__1 = xpos[i__ - 1] * outeng_c__;
	    do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
	}
	e_wsfe();
    }
...
/* --- NODE NUMBERS */
L508:
    l = outeng_itri_(&k, &outeng_c__1);
    m = outeng_itri_(&k, &outeng_c__2);
    n = outeng_itri_(&k, &outeng_c__3);
    rl = vert[l - 1];
    zl = vert[l + 29999];
    rm = vert[m - 1];
    zm = vert[m + 29999];
...
L509:
    zc = (zl + zm + zn) / 3.f;
    outeng_subd_(&d__, &rm, &zm, &rn, &zn, &rl, &zl);
/* --- FLUX DENSITIES */
    i__1 = l - 1;
    i__2 = l - 1;
    ...
    r__1 = r_imag(&bh);
    r__2 = bh.r;
    outeng_angle_(&r__1, &r__2, &outeng_c_b369, &e5, &pi);
    r__1 = r_imag(&bz);
    r__2 = bz.r;
    outeng_angle_(&r__1, &r__2, &outeng_c_b369, &e6, &pi);
    outeng_angle_(&cdensi[k - 1], &cdensr[k - 1], &outeng_c_b369, &e7, &pi);
    e13 = cdabs * 1e6f * sqr2;
    if (e12 < 4.5f) {
...
/* Computing 2nd power */
    r__1 = amax - amin;
    edtnk = ftank * xpos[outeng_block1_1.lnver - 1] * e1 * (r__1 * r__1);
/* --- LEG */
L533:
    q__1.r = cpotr[0], q__1.i = cpoti[0];
    amin = sqr2 * c_abs(&q__1);
    amax = amin;
    i1 = i6 - outeng_block1_1.lnver + 1;
    i__1 = i1;
    i__2 = outeng_block1_1.lnver;
...
/* --- UPPER YOKE */
/* Computing 2nd power */
    r__1 = xpos[outeng_block1_1.lnver - 1] + xpos[0];
    e1 = fyoke * .008f * xpos[0] * (xpos[outeng_block1_1.lnver - 1] - xpos[0]) / (
	    r__1 * r__1);
    i__2 = i6 - 1;
    i__1 = i6 - 1;
    ...
    e3 = sqr2 * c_abs(&q__1);
/* Computing 2nd power */
    r__1 = xpos[outeng_block1_1.lnver - 1] * e2 - xpos[0] * e3;
    edyok = e1 * (r__1 * r__1);
...
/* --- WRITE OUTPUT */
	...
	do_fio(&outeng_c__1, (char *)&seg[i__ - 1], (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&e1, (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 2399], (ftnlen)sizeof(real));
	r__1 = seg[i__ + 2599] * p;
	do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
	r__2 = seg[i__ + 2799] * p;
	do_fio(&outeng_c__1, (char *)&r__2, (ftnlen)sizeof(real));
	...
	r__4 = seg[i__ + 2999] * f;
	do_fio(&outeng_c__1, (char *)&r__4, (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 4799], (ftnlen)sizeof(real));
	r__5 = seg[i__ + 3199] * f;
	do_fio(&outeng_c__1, (char *)&r__5, (ftnlen)sizeof(real));
	r__6 = seg[i__ + 3399] * p;
	do_fio(&outeng_c__1, (char *)&r__6, (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 4999], (ftnlen)sizeof(real));
	r__7 = seg[i__ + 3599] * h__;
	do_fio(&outeng_c__1, (char *)&r__7, (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 5199], (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 5399], (ftnlen)sizeof(real));
	r__8 = seg[i__ + 3799] * e;
	do_fio(&outeng_c__1, (char *)&r__8, (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 5599], (ftnlen)sizeof(real));
	do_fio(&outeng_c__1, (char *)&seg[i__ + 3999], (ftnlen)sizeof(real));
	e_wsfe();
	if (seg[i__ + 1599] <= 50.f) {
	    io___243.ciunit = out;
	    s_wsfe(&io___243);
	    do_fio(&outeng_c__1, (char *)&seg[i__ + 5799], (ftnlen)sizeof(real));
	    e_wsfe();
	}
	if (seg[i__ + 1599] > 50.f) {
	    io___244.ciunit = out;
...
/* L558: */
    ...
    r__1 = crit[0] * e;
    do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&crit[5], (ftnlen)sizeof(real));
    r__2 = crit[1] * e;
    do_fio(&outeng_c__1, (char *)&r__2, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&crit[6], (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&crit[2], (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&crit[7], (ftnlen)sizeof(real));
    r__3 = crit[3] * e;
    do_fio(&outeng_c__1, (char *)&r__3, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&crit[8], (ftnlen)sizeof(real));
    r__4 = crit[4] * e;
    do_fio(&outeng_c__1, (char *)&r__4, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&crit[9], (ftnlen)sizeof(real));
    e_wsfe();
    io___249.ciunit = out;
    s_wsfe(&io___249);
    do_fio(&outeng_c__1, (char *)&vturn, (ftnlen)sizeof(real));
    r__1 = brtnk * b;
    do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
    r__2 = brleg * b;
    do_fio(&outeng_c__1, (char *)&r__2, (ftnlen)sizeof(real));
    ...
    io___250.ciunit = out;
    s_wsfe(&io___250);
    do_fio(&outeng_c__1, (char *)&mvamx, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&xpu, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&rpu, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&zpu, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&zsyst, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&ztot, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&zused, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&edwnd, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&edtnk, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&edleg, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&edyok, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&edtot, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&edpu, (ftnlen)sizeof(real));
    do_fio(&outeng_c__1, (char *)&dctot, (ftnlen)sizeof(real));
    e_wsfe();
    io___251.ciunit = out;
    s_wsfe(&io___251);
    e_wsfe();
...
/* --- EDDY CURRENT LOSS, PER UNIT */
	    ...
	    io___264.ciunit = out;
	    s_wsfe(&io___264);
	    do_fio(&outeng_c__1, (char *)&e3, (ftnlen)sizeof(real));
	    do_fio(&outeng_c__1, (char *)&e8, (ftnlen)sizeof(real));
	    do_fio(&outeng_c__1, (char *)&e9, (ftnlen)sizeof(real));
	    do_fio(&outeng_c__1, (char *)&e4, (ftnlen)sizeof(real));
	    do_fio(&outeng_c__1, (char *)&e5, (ftnlen)sizeof(real));
	    e_wsfe();
	    if (seg[l + 1599] <= 50.f) {
		io___265.ciunit = out;
		s_wsfe(&io___265);
		do_fio(&outeng_c__1, (char *)&e10, (ftnlen)sizeof(real));
		r__1 = e11 * outeng_c__;
		do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
		r__2 = e12 * outeng_c__;
		do_fio(&outeng_c__1, (char *)&r__2, (ftnlen)sizeof(real));
	    ...
	    r__1 = e15 * p;
	    do_fio(&outeng_c__1, (char *)&r__1, (ftnlen)sizeof(real));
	    do_fio(&outeng_c__1, (char *)&l, (ftnlen)sizeof(integer));
	    e_wsfe();
	    io___268.ciunit = out;
	    s_wsfe(&io___268);
	    r__1 = e6 * p;
		...
		outeng_subd_(&d__, &xm, &ym, &xn, &yn, &xl, &yl);
		i__4 = l - 1;
		i__5 = l - 1;
...
L570:
	    ...
	    io___278.ciunit = out;
	    s_wsfe(&io___278);
	    do_fio(&outeng_c__1, (char *)&flink, (ftnlen)sizeof(real));
	    e_wsfe();
...
L572:
	...
	io___279.ciunit = out;
	s_wsfe(&io___279);
	do_fio(&outeng_c__1, (char *)&i__, (ftnlen)sizeof(integer));
	e_wsfe();
	e5 = 0.f;
	if (e1 > 0.f) {
	    e5 = e2 / e1;
...
L998:
    ...
    s_wsue(&io___286);
    do_uio(&outeng_c__1, (char *)&thksh, (ftnlen)sizeof(real));
    do_uio(&outeng_c__1, (char *)&cdavg, (ftnlen)sizeof(real));
    do_uio(&outeng_c__1, (char *)&freq, (ftnlen)sizeof(real));
    e_wsue();
    o__1.oerr = 0;
    o__1.ounit = 4;
    // o__1.ofnmlen = 11;
	...
	do_fio(&outeng_c__1, (char *)&seg[i__ + 1799], (ftnlen)sizeof(real));
	for (j = 11; j <= 12; ++j) {
	    r__3 = seg[i__ + j * 200 - 201] * outeng_c__;
	    do_fio(&outeng_c__1, (char *)&r__3, (ftnlen)sizeof(real));
	}
	do_fio(&outeng_c__1, (char *)&seg[i__ + 2399], (ftnlen)sizeof(real));
	for (j = 14; j <= 15; ++j) {
	    r__4 = seg[i__ + j * 200 - 201] * p;
	    do_fio(&outeng_c__1, (char *)&r__4, (ftnlen)sizeof(real));
	}
	for (j = 16; j <= 17; ++j) {
	    r__5 = seg[i__ + j * 200 - 201] * f;
	    do_fio(&outeng_c__1, (char *)&r__5, (ftnlen)sizeof(real));
	}
	r__6 = seg[i__ + 3399] * p;
	do_fio(&outeng_c__1, (char *)&r__6, (ftnlen)sizeof(real));
	...
	do_fio(&outeng_c__1, (char *)&seg[i__ + 3999], (ftnlen)sizeof(real));
	for (j = 22; j <= 23; ++j) {
	    r__9 = seg[i__ + j * 200 - 201] * e;
	    do_fio(&outeng_c__1, (char *)&r__9, (ftnlen)sizeof(real));
	}
	r__10 = seg[i__ + 4599] * g;
	do_fio(&outeng_c__1, (char *)&r__10, (ftnlen)sizeof(real));
	for (j = 25; j <= 31; ++j) {
	    do_fio(&outeng_c__1, (char *)&seg[i__ + j * 200 - 201], (ftnlen)sizeof(
		    real));
	}
	for (j = 32; j <= 35; ++j) {
	    r__11 = seg[i__ + j * 200 - 201] * p;
	    do_fio(&outeng_c__1, (char *)&r__11, (ftnlen)sizeof(real));
	}
	for (j = 36; j <= 39; ++j) {
	    r__12 = seg[i__ + j * 200 - 201] * outeng_c__;
	    do_fio(&outeng_c__1, (char *)&r__12, (ftnlen)sizeof(real));
	}
	r__13 = seg[i__ + 7799] * 645.16f;
	do_fio(&outeng_c__1, (char *)&r__13, (ftnlen)sizeof(real));
	e_wsfe();
/* L999: */
    }
    cl__1.cerr = 0;
...
/* Subroutine */ int outeng_subd_(real *d__, real *xm, real *ym, real *xn, real *yn, 
	real *xl, real *yl)
{
    /* System generated locals */
...
integer outeng_itri_(integer *i__, integer *j)
{
    /* System generated locals */
    integer ret_val = 0;
...
/* --- ROW NUMBER */
    m = (*i__ - 1) / ((outeng_block1_1.lnver - 1) << 1) + 1;
/* --- COLUMN NUMBER */
    n = (*i__ - 1) / 2 + outeng_block1_1.lnver - m * (outeng_block1_1.lnver - 1);
/* --- LOWER LEFT CORNER */
    l = n + (m - 1) * outeng_block1_1.lnver;
    a = bit_test(outeng_block1_1.ibit[l - 1],15);
    if (a) {
	goto L120;
    }
/* --- NORMAL DIAGONAL */
...
/* --- FIRST TRIANGLE */
    if (*j == 2) {
	ret_val = l + outeng_block1_1.lnver + 1;
    }
    if (*j == 3) {
	ret_val = l + outeng_block1_1.lnver;
    }
    goto L200;
/* --- SECOND TRIANGLE */
L110:
...
/* Subroutine */ int outeng_angle_(real *a1, real *b1, real *d1, real *angrd, real *
	pi)
{
    /* Builtin functions */
