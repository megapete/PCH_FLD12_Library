...
+ (NSString * _Nonnull)RunFLD12withString:(NSString *_Nonnull)fileString outputType:(PCH_FLD12_OutputType)outputType fluxLineString:(NSString *_Nullable*_Nullable)fluxLinePtr fld8String:(NSString *_Nullable*_Nullable)fld8Ptr;
